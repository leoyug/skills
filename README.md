...
| `writing-dna-skill` | https://github.com/larashero3-dotcom/writing-dna-skill | Distills reusable writing DNA from a corpus of at least 20 complete articles, then uses the layered style artifacts and five related originals for consistent writing. Includes the `lieflat-less-ai-tone` companion skill. |
